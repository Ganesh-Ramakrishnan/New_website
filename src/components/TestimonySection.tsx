      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {loopedTestimonies.map((t, idx) => (
            <div key={idx} className="min-w-[320px] max-w-xs border border-gray-800 rounded-xl liener_bg shadow-sm flex flex-col h-full bg-gray-900">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <p className="light_grey text-base mb-6" style={{minHeight: '95px'}}>"{t.text}"</p>
